          ...
          <div className="p-6 space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <div className="bg-purple-50 dark:bg-purple-900/20 border border-purple-100 dark:border-purple-800 rounded-xl p-6">
                ...
                <p className="text-3xl font-bold text-purple-700 dark:text-purple-300">{metrics.totalAgents}</p>
                <p className="text-xs text-purple-500 dark:text-purple-400 mt-1">{metrics.activeAgents} active</p>
              </div>
              <div className="bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-100 dark:border-emerald-800 rounded-xl p-6">
                ...
                <p className="text-3xl font-bold text-emerald-700 dark:text-emerald-300">{metrics.totalExecutions}</p>
                <p className="text-xs text-emerald-500 dark:text-emerald-400 mt-1">{metrics.successRate}% success</p>
              </div>
              <div className="bg-sky-50 dark:bg-sky-900/20 border border-sky-100 dark:border-sky-800 rounded-xl p-6">
                ...
                <p className="text-3xl font-bold text-sky-700 dark:text-sky-300">{metrics.totalTokens.toLocaleString()}</p>
              </div>
              <div className="bg-teal-50 dark:bg-teal-900/20 border border-teal-100 dark:border-teal-800 rounded-xl p-6">
                ...
                <p className="text-3xl font-bold text-teal-700 dark:text-teal-300">${metrics.totalCost.toFixed(3)}</p>
              </div>
            </div>
